...
#Mengubah directory program
os.chdir("D:/Coolyeah/FileTubes") 
os.getcwd()#lokasi jalannya program
...
def signup(du):
    ...
    epass=enc(passw)
    newacc=[name,tl,tb,uName,epass,"Player","0","No"]
...
#save("Refund",dr,mark)
#save("Kritik dan Saran",dks,mark)
#save("Keihilangan Tiket",dth,mark)
#print("Data berhasil disimpan")
